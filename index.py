...
name = st.sidebar.title("🚀Welcome to Growth Mindset journey 🌟")
name = st.sidebar.text_input("👤 Enter Your Name:")
fname = st.sidebar.text_input("👤 Enter Your Skills")
st.sidebar.button("Submit")
st.sidebar.write("🌱 Created by KASHAF AMAN")
...
st.write(" This app is designed to help you 📊 develop a growth mindset ⚡.")
st.write("🌱 Created by KASHAF AMAN")
st.balloons()
# 🌟 🔍 📢 ⚡ 📊
